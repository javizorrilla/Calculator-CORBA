    ...
    public static void main(String[] args) {
	    ...
	    calcObj = (Calc) CalcHelper.narrow(ncRef.resolve_str("Calculator"));
            ...
            while(true) {
                ...
                System.out.println("------------------------------------------");
                System.out.println("The operations that can be performed are the following:\n- Addition\n- Subtraction\n- Multiplication\n- Division\n- Pow\n- Exit calculator");
		...
		String input = c.nextLine();
                ...
                if (inputParams[0].equals("+")) {
                    ...
                    operatorCode = 4;
                } else if (inputParams[0].equals("pow")) {
                    operatorCode = 5;
                } else {
                ...
                try {
                    operand1 = Double.parseDouble(inputParams[1]);
                    operand2 = Double.parseDouble(inputParams[2]);
                }
		...
		double result = calcObj.calculate(operatorCode, operand1, operand2);
                String resultDisplay = "";
                if (result == Double.MAX_VALUE) {
                    resultDisplay = "There might be an Double Overflow. Please try again...";
                }
                else if (result == Double.MIN_VALUE) {
                    resultDisplay = "There might be an Double Underflow. Please try again...";
                }
                else {
